...
while guess_count<=10:
   ...
   guessed_number=input("my guess was {0}, should i guess higher (type h for that ),should i type lower (type l for that ), or am i right(type c for that ) ".format(guessed)).casefold()
   if guessed_number=='h':
       low_point=guessed+1
   if guessed_number=='l':
