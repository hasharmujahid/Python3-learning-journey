...
button_equals = Button(root, text="=", padx=91, pady=20, bg="black", fg="red", command=equals)
button_clear = Button(root, text="Clear", padx=80, pady=20, bg="black", fg="red", command=clear)
